                    ...
                    if(isset($_POST['submit'])) {
                        ...
                        if(isset($_FILES['cover']) && $_FILES['cover']['error'] == 0) {
                            ...
                            if(move_uploaded_file($tmp_file, $upload_path . $nama_file)) {
                                $query = mysqli_query($koneksi, "INSERT INTO buku(id_kategori, judul, penulis, penerbit, tahun_terbit, deskripsi, gambar) VALUES ('$id_kategori', '$judul', '$penulis', '$penerbit', '$tahun_terbit', '$deskripsi', '$nama_file')");
